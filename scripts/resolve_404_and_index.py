...
JUNK_PATTERNS = [
    ...
    r"\.(json|npmrc|yml|yaml|toml|conf|config|pem|key)$", r"\.(aws|cursor|openai|openclaw|ssh|docker)/",
    r"secrets?", r"credentials?", r"serviceaccount", r"config.*\.json",
    r"\.aws$", r"\.npmrc$", r"^\.[a-z]",  # 숨김 파일/폴더로 시작하는 스캔성 경로
]
