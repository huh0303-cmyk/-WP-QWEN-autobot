...
ORDER=['nasa','history','invention','silent_era','retro_reels']

def main():
    service=get_sheets_service();sid=os.environ['SHEET_ID']
    batch=os.environ.get('SAMPLE_BATCH_ID','knowledge-samples-20260907')
    ...
    for channel in ORDER:
        ...
        Path('artifacts/knowledge-private-samples.json').write_text(json.dumps(results,ensure_ascii=False,indent=2),encoding='utf-8')
