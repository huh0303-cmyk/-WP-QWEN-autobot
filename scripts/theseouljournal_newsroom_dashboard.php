...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('sj26-libre-caslon', 'https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&family=Libre+Caslon+Text:wght@400;700&family=Pirata+One&family=UnifrakturMaguntia&display=swap', array(), null);
}, 20);
...
add_action('wp_footer', function () {
    ...
    <style id="sj26-newsroom-style">
      ...
      body.wp-theme-mission-news{background:#f7f5ef!important;color:#111!important;font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news .site-header{width:calc(100% - 24px)!important;max-width:1600px!important;margin:0 auto!important;padding-top:0!important;background:#fff!important;border-top:5px solid #111!important}body.wp-theme-mission-news .top-nav{border-bottom:1px solid #111!important;font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news #title-container{padding:18px 12px 15px!important;text-align:center!important}body.wp-theme-mission-news #title-container .site-title{font-family:"UnifrakturMaguntia",Georgia,serif!important;font-size:clamp(60px,8vw,104px)!important;font-weight:400!important;line-height:.98!important;letter-spacing:-.018em!important}body.wp-theme-mission-news #title-container .site-title a{color:#050505!important;text-decoration:none!important}body.wp-theme-mission-news #title-container .date,body.wp-theme-mission-news #title-container .tagline{font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news #title-container .tagline{letter-spacing:.15em!important;text-transform:uppercase!important}body.wp-theme-mission-news #toggle-navigation,body.wp-theme-mission-news #menu-primary-container{display:none!important}.sj26-category-nav{display:flex;justify-content:center;gap:34px;padding:11px 14px 10px;border-top:4px double #111;border-bottom:4px double #111;overflow-x:auto;white-space:nowrap}.sj26-category-nav a{color:#111!important;font:700 13px Inter,Arial,sans-serif!important;text-decoration:none;text-transform:uppercase}body.wp-theme-mission-news #main{width:calc(100% - 24px)!important;max-width:1600px!important;margin:0 auto!important;padding:0!important}body.wp-theme-mission-news #above-main{display:none!important}body.wp-theme-mission-news #loop-container{width:100%!important;max-width:none!important}body.wp-theme-mission-news .post-title,body.wp-theme-mission-news .post-title a{font-family:Georgia,"Times New Roman",serif!important;word-break:normal!important;overflow-wrap:break-word!important}.sj-mast-s{display:inline-block;font-family:"Pirata One",Georgia,serif!important;transform:scale(.94,1.02);transform-origin:center bottom}
    ...
    <script id="sj26-newsroom-script">
      document.addEventListener('DOMContentLoaded',()=>{
        document.querySelectorAll('.site-title a,.news-brand').forEach(el=>{if(!el.querySelector('.sj-mast-s'))el.innerHTML=el.textContent.replace('Seoul','<span class="sj-mast-s">S</span>eoul');});
        ...
        if(isNewsTheme){const links='<a href="/">Top Stories</a><a href="/category/korea/">Korea</a><a href="/category/asia/">Asia</a><a href="/category/world/">World</a><a href="/category/business/">Business</a><a href="/category/technology/">Technology</a>';const nav=document.querySelector('#navbar-wp ul.nav')||document.querySelector('#primary-menu ul');if(nav)nav.innerHTML=links.replaceAll('<a ','<li class="nav-item"><a ').replaceAll('</a>','</a></li>');if(document.body.classList.contains('wp-theme-mission-news')&&!document.querySelector('.sj26-category-nav')){const n=document.createElement('nav');n.className='sj26-category-nav';n.innerHTML=links;document.querySelector('#title-container')?.after(n);}}
