...
add_action('wp_footer', function () {
    ...
    <script id="sj26-newsroom-script">
      document.addEventListener('DOMContentLoaded',()=>{
        ...
        const dash=document.getElementById('sj26-dashboard'),wrap=document.querySelector('.newsroom-wrap')||document.querySelector('#content.container-fluid.home')||document.querySelector('body.wp-theme-covernews #content.container'); if(!wrap||!dash)return;
        const isNewsTheme=document.body.classList.contains('wp-theme-newsup')||document.body.classList.contains('wp-theme-covernews');
