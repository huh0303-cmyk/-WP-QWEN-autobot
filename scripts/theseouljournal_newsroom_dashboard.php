...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('sj26-libre-caslon', 'https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&family=Libre+Caslon+Text:wght@400;700&family=Pirata+One&display=swap', array(), null);
}, 20);
...
add_action('wp_footer', function () {
    ...
    <script id="sj26-newsroom-script">
      document.addEventListener('DOMContentLoaded',()=>{
        const dash=document.getElementById('sj26-dashboard'),wrap=document.querySelector('.newsroom-wrap')||document.querySelector('#content.container-fluid.home'); if(!wrap||!dash)return;
        const isNewsup=document.body.classList.contains('wp-theme-newsup');
        ...
        if(isNewsup){const nav=document.querySelector('#navbar-wp ul.nav');if(nav)nav.innerHTML='<li class="nav-item"><a class="nav-link" href="/">Top Stories</a></li><li class="nav-item"><a class="nav-link" href="/category/korea/">Korea</a></li><li class="nav-item"><a class="nav-link" href="/category/asia/">Asia</a></li><li class="nav-item"><a class="nav-link" href="/category/world/">World</a></li><li class="nav-item"><a class="nav-link" href="/category/business/">Business</a></li><li class="nav-item"><a class="nav-link" href="/category/technology/">Technology</a></li>';}
