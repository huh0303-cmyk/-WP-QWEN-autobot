...
add_action('wp_footer', function () {
    ...
    <script id="sj26-newsroom-script">
      document.addEventListener('DOMContentLoaded',()=>{
        ...
        if(isNewsTheme){const links='<a href="/category/politics/">Politics</a><a href="/category/economy/">Economy</a><a href="/category/culture/">Culture</a><a href="/category/uncategorized/">Global</a>';const nav=document.querySelector('#navbar-wp ul.nav')||document.querySelector('#primary-menu ul');if(nav)nav.innerHTML=links.replaceAll('<a ','<li class="nav-item"><a ').replaceAll('</a>','</a></li>');if(document.body.classList.contains('wp-theme-mission-news')&&!document.querySelector('.sj26-category-nav')){const n=document.createElement('nav');n.className='sj26-category-nav';n.innerHTML=links;document.querySelector('#title-container')?.after(n);}}
