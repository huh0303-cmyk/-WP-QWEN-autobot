...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('sj26-libre-caslon', 'https://fonts.googleapis.com/css2?family=Libre+Caslon+Display&family=Libre+Caslon+Text:wght@400;700&display=swap', array(), null);
}, 20);
...
add_action('wp_footer', function () {
    ...
    <style id="sj26-newsroom-style">
      ...
      .newsroom-wrap{background:#fff!important;color:var(--sj-ink)!important}.news-mast{background:#fff!important;border-top:1px solid var(--sj-ink)!important;border-bottom:4px double var(--sj-ink)!important}.news-brand{font-family:"Libre Caslon Display",Georgia,serif!important;font-size:clamp(48px,7vw,92px)!important;font-weight:400!important;letter-spacing:-.035em!important;color:#080808!important}.news-tag,.news-topline,.news-nav{font-family:"Libre Caslon Text",Georgia,serif!important}.news-nav{border-top:1px solid var(--sj-rule)!important;padding-top:11px!important}
