...
add_action('wp_footer', function () {
    ...
    <aside id="sj26-dashboard" class="sj26-dashboard" aria-label="Daily data desk">
      ...
      <section class="sj26-panel sj26-markets"><header><h2>Market Board</h2><span><?php echo esc_html(wp_date('M j')); ?></span></header>
        ...
        <?php endforeach; ?>
        <a class="sj26-source" href="https://finance.yahoo.com/" target="_blank" rel="noopener noreferrer">Daily prices: Yahoo Finance</a>
      </section>

      <section class="sj26-panel sj26-gold"><header><h2>Gold Price</h2><span><?php echo esc_html(wp_date('M j')); ?></span></header>
        <?php foreach ($quotes as $quote) : if ('gold' !== $quote['group']) continue; $dir = $quote['percent'] >= 0 ? 'up' : 'down'; ?>
          <div class="sj26-quote <?php echo esc_attr($dir); ?>"><strong>Gold<small>USD / troy oz</small></strong><span>$<?php echo esc_html(number_format($quote['price'], 2)); ?><small>per ounce</small></span><b><?php echo esc_html(sprintf('%+.2f%%', $quote['percent'])); ?></b></div>
        <?php endforeach; ?><a class="sj26-source" href="https://finance.yahoo.com/quote/GC=F/" target="_blank" rel="noopener noreferrer">Daily gold futures: Yahoo Finance</a>
      </section>
    ...
    <style id="sj26-newsroom-style">
      ...
      body.wp-theme-mission-news{background:#f7f5ef!important;color:#111!important;font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news .site-header{width:calc(100% - 24px)!important;max-width:1600px!important;margin:0 auto!important;padding-top:0!important;background:#fff!important;border-top:5px solid #111!important}body.wp-theme-mission-news .top-nav{border-bottom:1px solid #111!important;font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news #title-container{padding:18px 12px 15px!important;text-align:center!important}body.wp-theme-mission-news #title-container .site-title{font-family:"Playfair Display",Georgia,serif!important;font-size:clamp(58px,7.4vw,98px)!important;font-weight:800!important;line-height:1!important;letter-spacing:-.045em!important}body.wp-theme-mission-news #title-container .site-title a{color:#050505!important;text-decoration:none!important}body.wp-theme-mission-news #title-container .date,body.wp-theme-mission-news #title-container .tagline{font-family:Inter,Arial,sans-serif!important}body.wp-theme-mission-news #title-container .tagline{letter-spacing:.12em!important;text-transform:none!important}body.wp-theme-mission-news #toggle-navigation,body.wp-theme-mission-news #menu-primary-container{display:none!important}.sj26-category-nav{display:flex;justify-content:center;gap:44px;padding:11px 14px 10px;border-top:4px double #111;border-bottom:4px double #111;overflow-x:auto;white-space:nowrap}.sj26-category-nav a{position:relative;color:#111!important;font:700 13px Inter,Arial,sans-serif!important;text-decoration:none;text-transform:uppercase}.sj26-category-nav a:after{content:"";position:absolute;left:50%;right:50%;bottom:-5px;height:2px;background:#b20f21;transition:left .22s ease,right .22s ease}.sj26-category-nav a:hover:after{left:0;right:0}.sj26-latest-strip{display:flex;align-items:stretch;max-width:1600px;margin:0 auto;background:#fff;border-bottom:1px solid #c9c5bc;overflow:hidden}.sj26-latest-label{display:flex;align-items:center;gap:7px;flex:0 0 auto;padding:0 18px;background:#b20f21;color:#fff;font:800 11px Inter,Arial,sans-serif;letter-spacing:.1em}.sj26-latest-bolt{font-size:14px;animation:sj26-pulse 1.35s ease-in-out infinite}.sj26-latest-window{overflow:hidden;padding:10px 0;white-space:nowrap}.sj26-latest-track{display:inline-flex;gap:42px;padding-left:35px;animation:sj26-ticker 40s linear infinite;will-change:transform}.sj26-latest-track:hover{animation-play-state:paused}.sj26-latest-track a{color:#171717!important;font:600 12px Inter,Arial,sans-serif!important;text-decoration:none}.sj26-latest-track a:before{content:"◆";margin-right:10px;color:#b20f21;font-size:7px}.sj26-latest-track a:hover{text-decoration:underline}body.wp-theme-mission-news #sidebar-left,body.wp-theme-mission-news #sidebar-right{display:none!important}body.wp-theme-mission-news #main{width:calc(100% - 24px)!important;max-width:1600px!important;margin:0 auto!important;padding:0!important}body.wp-theme-mission-news #above-main{display:none!important}body.wp-theme-mission-news #main>.sj26-layout{margin-top:0!important}body.wp-theme-mission-news .sj26-dashboard{top:0!important}body.wp-theme-mission-news #loop-container{width:100%!important;max-width:none!important}body.wp-theme-mission-news .post-title,body.wp-theme-mission-news .post-title a{font-family:Georgia,"Times New Roman",serif!important;word-break:normal!important;overflow-wrap:break-word!important}body.wp-theme-mission-news .post-byline{display:block!important;margin:9px 0 12px!important;color:#6b6258!important;font:700 11px/1.4 Inter,Arial,sans-serif!important;letter-spacing:.045em!important;text-transform:none!important;opacity:1!important;visibility:visible!important}body.wp-theme-mission-news .post-byline:before{content:none!important}body.wp-theme-mission-news #loop-container .entry{transition:transform .24s ease,box-shadow .24s ease;background:#fff}body.wp-theme-mission-news #loop-container .entry:hover{transform:translateY(-5px);box-shadow:0 12px 28px rgba(0,0,0,.08);z-index:2}body.wp-theme-mission-news #loop-container img{transition:transform .35s ease}body.wp-theme-mission-news #loop-container .entry:hover img{transform:scale(1.025)}@keyframes sj26-ticker{from{transform:translateX(0)}to{transform:translateX(-50%)}}@keyframes sj26-pulse{50%{opacity:.3;transform:scale(.75)}}@media(prefers-reduced-motion:reduce){.sj26-latest-track,.sj26-latest-bolt{animation:none!important}body.wp-theme-mission-news #loop-container .entry,body.wp-theme-mission-news #loop-container img{transition:none!important}}
      ...
      body.single-post .entry-title,body.single-post .article-title{font-family:"Libre Caslon Text",Georgia,"Times New Roman",serif!important;font-weight:700!important;line-height:1.16!important;letter-spacing:-.025em!important}body.single-post .entry-content,body.single-post .article-content{font-family:"Libre Caslon Text",Georgia,"Times New Roman",serif!important;font-size:19px!important;line-height:1.78!important;color:#181818!important}body.single-post .entry-content p,body.single-post .article-content p{margin:0 0 1.15em!important}body.single-post .entry-content h2,body.single-post .article-content h2{font-family:"Libre Caslon Text",Georgia,serif!important;font-size:27px!important;line-height:1.25!important;margin:1.7em 0 .6em!important}
      ...
      body.wp-theme-mission-news .post-byline:after{content:attr(data-sj-byline);color:#6b6258;font:700 11px/1.4 Inter,Arial,sans-serif;letter-spacing:.045em}
      body.wp-theme-mission-news #loop-container{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:30px 26px!important;align-items:start!important;height:auto!important}
      body.wp-theme-mission-news #loop-container>.entry{position:static!important;left:auto!important;top:auto!important;float:none!important;width:auto!important;margin:0!important;padding:0 0 24px!important;border-bottom:1px solid #d8d4ca!important;box-shadow:none!important}
      body.wp-theme-mission-news #loop-container>.entry article{height:auto!important}
      body.wp-theme-mission-news #loop-container .featured-image{margin:0 0 15px!important;overflow:hidden;background:#ece9e1}
      body.wp-theme-mission-news #loop-container .featured-image a{display:block;font-size:0!important}
      body.wp-theme-mission-news #loop-container .featured-image img{display:block;width:100%!important;height:230px!important;object-fit:cover!important}
      body.wp-theme-mission-news #loop-container .post-header{padding:0 2px!important}
      body.wp-theme-mission-news #loop-container .post-title{margin:0!important;font-size:clamp(24px,2.25vw,35px)!important;line-height:1.08!important;letter-spacing:-.025em!important}
      body.wp-theme-mission-news #loop-container .post-content{padding:0 2px!important;font:400 14px/1.65 Inter,Arial,sans-serif!important;color:#36332e!important}
      body.wp-theme-mission-news #loop-container .read-more{padding:0!important;background:transparent!important;color:#9f1423!important;border:0!important;font-size:11px!important;font-weight:800!important;letter-spacing:.08em!important;text-transform:uppercase}
      body.wp-theme-mission-news .site-footer{width:calc(100% - 24px)!important;max-width:1600px!important;margin:0 auto!important;background:#fff!important;border-top:4px double #111!important;color:#333!important}
      body.wp-theme-mission-news .site-footer a[href*="competethemes.com"],body.wp-theme-mission-news .site-footer .design-credit{display:none!important}
      @media(max-width:720px){body.wp-theme-mission-news #loop-container{grid-template-columns:1fr!important;gap:24px!important}body.wp-theme-mission-news #loop-container .featured-image img{height:auto!important;aspect-ratio:16/9}.sj26-latest-label{padding:0 11px!important;font-size:9px!important}.sj26-category-nav{justify-content:flex-start!important;gap:24px!important}}
    </style>
