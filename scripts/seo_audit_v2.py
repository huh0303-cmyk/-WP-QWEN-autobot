# -*- coding: utf-8 -*-
"""
27개 사이트 전체 발행글을 실제 원본 estimate_seo_score() 로직 그대로 재채점한다.
- rank_math_focus_keyword / rank_math_description을 REST API meta 필드로 실제 조회
  (근사치가 아니라 발행 당시와 동일한 기준)
- FAQ는 schema.org/Question 마커로 정확히 카운트
"""
...
if __name__ == "__main__":
    results = [audit_site(s) for s in SITES_CONFIG]
    with open("seo_audit_v2_result.json", "w", encoding="utf-8") as f:
