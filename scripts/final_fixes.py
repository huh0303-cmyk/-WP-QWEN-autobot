...
try:
    ...
    try:
        ...
        log["kskin365_location_fix"] = {"exception": str(e)}
    with open("final_fixes_result.json", "w", encoding="utf-8") as f:
        json.dump(log, f, ensure_ascii=False, indent=2)
    ...
    try:
        ...
        for pid in BROKEN_IDS:
            try:
                ...
                log["ktrip365_title_fix"].append({"id": pid, "exception": str(e)})
            with open("final_fixes_result.json", "w", encoding="utf-8") as f:
                json.dump(log, f, ensure_ascii=False, indent=2)
    except Exception as e:
        log["ktrip365_fatal"] = str(e)
