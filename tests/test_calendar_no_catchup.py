...
@pytest.mark.parametrize("offset,eligible", [(-1440, False), (-60, False), (-29, True), (-1, True), (0, True), (1, False)])
def test_bounded_polling_window_dispatches_recent_slots_only(offset, eligible):
