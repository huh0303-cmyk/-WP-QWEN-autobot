...
- Newsrooms: **2 destinations** (`koreanews365.com`, `theseouljournal.com`), **new RSS items trigger publication; no daily minimum, maximum, or fixed publication slots**, driven by timely RSS/primary-source leads. Each brief must contain **700–1,500 visible characters**, retain source attribution, reject duplicate source URLs, and run through the single newsroom owner lock.
