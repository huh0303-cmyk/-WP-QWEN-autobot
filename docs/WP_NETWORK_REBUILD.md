...
8. `kskin365.com` is active again and included in the 27-site network. `k-health365.com` is rebuilt first. `jobkoreaglobal.com` ownership was reconfirmed 2026-08-29 (domain repurchased by the owner) and it is back to normal `active` status alongside the other 26 sites.
