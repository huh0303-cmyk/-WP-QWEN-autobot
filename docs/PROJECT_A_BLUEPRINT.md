...
Only independently verifiable external evidence may create the state VERIFIED COMPLETE.
...
CODEX does not own the final VERIFIED COMPLETE flag.
...
The blueprint is not considered deployed to the VPS until the sync script copies the exact Git commit version and records its SHA.

---

## 13. Change log

- 2026-09-16: Project A formally named. CODEX primary PM, Claude Plan B Acting PM + audit lead, Gemini Plan C continuity. Deterministic external-evidence audit made sole authority for VERIFIED COMPLETE. GitHub/VPS dual-copy policy established.
