...
def vocabulary_status(config_path=None):
    ...
    accounts=[
      {'platform':'YouTube Shorts','topik':'TOPIK · @seoultopik (등록값)','english':'English Survival · @English_Survival','language':'SIS-Language Center · @sis_languagecenter','status':'채널 지정 · 업로드 인증 확인 대기'},
